...
customer_order_post_parser.add_argument('ord_id', type=str, required=True, location=['json'],help='name parameter is required')
customer_order_post_parser.add_argument('ord_dt', type=str, required=True, location=['json'],help='name parameter is required')
customer_order_post_parser.add_argument('qt_ordd', type=str, required=True, location=['json'],help='name parameter is required')


class CustomerOrderResource(Resource):
    def get(self, customer_order_id=None):
        if customer_order_id:
            customer_order = CustomerOrder.query.filter_by(id=customer_order_id).first()
            ...
            customer_order = CustomerOrder.query.filter_by(**args).order_by(CustomerOrder.id)
